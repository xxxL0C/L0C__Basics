...
![Latest Version](https://img.shields.io/badge/ver-1.0.0-1458b8?style=flat-square&labelColor=black)
...
| 依存パッケージ | なし |
| 名前空間 | `XXXL0C.ExBasics`<br/>`XXXL0C.ExBasics.Editor` |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `name` | `string` | :o: | \- | 表示するラベル文字列。 `string.Empty` / `""` の場合はラベル非表示 |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `name` | `string` | :o: | \- | グループ名（同名のフィールドは同一グループに格納） |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `condition` | `string` | :o: | \- | 参照する `bool` フィールドまたはメソッドの名前 |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `callback` | `string` | :o: | \- | コールバックするメソッド名（パラメータなし・戻り値 `void`） |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `min` | `float` | :o: | \- | スライダーの最小値 |
| `max` | `float` | :o: | \- | スライダーの最大値 |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `min` | `float` | :o: | \- | スライダーの下限   |
| `max` | `float` | :o: | \- | スライダーの上限   |
| `step` | `float` | \- | `0` | スナップする刻み幅 |
...
| パラメータ | 型 | 必須 | 初期値 | 説明 |
| --- | :---: | :---: | :---: | --- |
| `target` | `Type` | :o: | \- | 絞り込み対象の基底クラス / インターフェース |
...
![X(Development)](https://img.shields.io/badge/%40xxxL0C-black?style=flat&logo=x&logoColor=white&labelColor=black&link=https%3A%2F%2Fx.com%2FxxxL0C)

![Github Organization](https://img.shields.io/badge/-black?style=flat-square&logo=github&logoColor=white&labelColor=black&link=https%3A%2F%2Fgithub.com%2FxxxL0C)![Bluesky(Personal)](https://img.shields.io/badge/-black?style=flat-square&logo=bluesky&logoColor=white&labelColor=black&link=https%3A%2F%2Fbsky.app%2Fprofile%2Fxxxl0c.works)
